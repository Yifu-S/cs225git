...
/**
 * @brief debug log by Yifu Song
 * 1. loadRooms: use countRooms to create rooms, similar to countStudents
 * 2. loadRooms: i++ position wrong, should be at the end of the loop
 * 3. ~Allocator(): add a destructor to run automaticlly at the end of the program
 * 
 */