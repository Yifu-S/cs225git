...
void AVLTree<K, V>::rebalance(Node*& subtree)
{
    ...
    {
        if (heightOrNeg1(subtree->right->right) - heightOrNeg1(subtree->right->left) > 0)   rotateLeft(subtree);
        else    rotateRightLeft(subtree);
    }
    if (heightOrNeg1(subtree->right) - heightOrNeg1(subtree->left) < -1)
    {
        if (heightOrNeg1(subtree->left->right) - heightOrNeg1(subtree->left->left) < 0)   rotateRight(subtree);
